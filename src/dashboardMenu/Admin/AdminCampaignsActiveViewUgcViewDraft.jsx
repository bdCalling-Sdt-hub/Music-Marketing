...
const AdminCampaignsActiveViewUgcViewDraft = () => {
        ...
        <div>
            ...
            <div className='my-10 w-52'>
                ...
                <div className='space-y-3 my-5'>
                    <Link to={`/admin/campaigns/active/view-feedback`} className='block text-center py-3 w-full bg-[#344331] text-white rounded-lg' >
                        View Feedback
                    </Link>
...
export default AdminCampaignsActiveViewUgcViewDraft;
