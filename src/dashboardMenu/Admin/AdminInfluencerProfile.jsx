        ...
        <div className="">
            ...
            <div className="mt-10">
                <div className="flex justify-between items-center mb-5">
                    ...
                    <Link to={`/admin/influencers/all/influencers`} className="border border-gray-600 text-gray-600 py-2 px-5 rounded-lg">View All</Link>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-5">
                    {campaignData.map((campaign) => (
                        <div key={campaign.id} className="p-4 border rounded-lg shadow-md">
                            ...
                            <div className='mt-5 '>
                                <Link to={`/admin/influencers/influencer-activity/${campaign.id}`} className="border border-gray-600 text-gray-600 py-2 px-4 rounded-lg w-full block text-center mt-2">
                                    View Activity
                                </Link>
                            </div>
                        </div>
