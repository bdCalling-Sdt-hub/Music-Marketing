...
const AdminInfluencerProfile = () => {
    return (
        <div className="p-5">
            {/* Back Button */}
            <Link to={'/admin/influencers'} className='flex items-center gap-2 text-2xl font-semibold mb-5'>
                <FaAngleLeft />
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='space-y-4 text-right'>
                    ...
                    <Link to={`/admin/influencers/pay`} className='block px-20 py-3 bg-[#344331] rounded-lg text-white'>Pay Influencer</Link>
                </div>
            </div>
                    ...
                    <div className="border border-secondary bg-[url('/influencer/Home/campaignIcons/campaindetailsGroup.png')] bg-cover bg-center h-full w-full p-5">
                        <div className='grid grid-cols-2 gap-3'>
                            ...
                            <div>
                                ...
                                <Link to={`/admin/influencers/influencer-activity/${1}`} className="border mt-3 w-full border-gray-600 block text-center text-gray-600 py-2 px-5 rounded-lg">View Details</Link>
                            </div>
                        </div>
                    ...
                    <div className="border border-secondary bg-[url('/influencer/Home/campaignIcons/campaindetailsGroup.png')] bg-cover bg-center h-full w-full p-5">
                        <div className='grid grid-cols-2 gap-3'>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-2">Happening in 2 days</p>
                                <h2 className='text-3xl font-semibold'>$1520</h2>
                                <Link to={`/admin/influencers/influencer-activity/${2}`} className="border mt-3 w-full border-gray-600 block text-center text-gray-600 py-2 px-5 rounded-lg">View Details</Link>
                            </div>
                        </div>
                        {/* <button className="mt-4 bg-blue-500 text-white py-2 px-4 rounded-lg">View Details</button> */}
                    </div>
                    <div className="border border-secondary bg-[url('/influencer/Home/campaignIcons/campaindetailsGroup.png')] bg-cover bg-center h-full w-full p-5">
                        <div className='grid grid-cols-2 gap-3'>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-2">Happening in 2 days</p>
                                <h2 className='text-3xl font-semibold'>$1520</h2>
                                <Link to={`/admin/influencers/influencer-activity/${3}`} className="border mt-3 w-full border-gray-600 block text-center text-gray-600 py-2 px-5 rounded-lg">View Details</Link>
                            </div>
                        </div>
                        {/* <button className="mt-4 bg-blue-500 text-white py-2 px-4 rounded-lg">View Details</button> */}
                    </div>
