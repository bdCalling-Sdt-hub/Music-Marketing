    ...
    return (
        <div className="p-5">
            <Link to="/admin/influencers" className="flex items-center gap-2 text-2xl font-semibold mb-5">
                <FaAngleLeft className='text-2xl' /> Remove Influncer
            </Link>
            ...
            >
                <h2 className="font-semibold mb-5">Remove Influncer</h2>
                {/* Full Name Field */}
                <Form.Item
                    label="Full Name"
                    name="fullName"
...
export default AdminInfluencerRemove;
