...
const ClientInfluencerProfileDetails = () => {

    const menu = (
        <Menu>
            <Link target='_blank' to={`https://mail.google.com/mail/u/0/?fs=1&to=infosahinur@gmail.com&tf=cm`}>
                <Menu.Item key="2" icon={<FaEnvelope className="text-green-500 text-2xl" />}>
                    Email
                </Menu.Item>
            </Link>
            <a href="tel:+1234567890" >
                <Menu.Item key="1" icon={<FaPhone className="text-blue-500 text-2xl" />}>
                    Phone
                </Menu.Item>
            </a>
        </Menu>
        ...
        <div className="p-5 bg-gray-100 min-h-screen">
            ...
            <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex space-x-5 items-center">
                    <Link to={'/client/profile/editprofile'} className="flex items-center text-blue-500 font-semibold hover:underline">
                        <MdEdit className="mr-2" /> Edit Profile
                    </Link>
                    <Dropdown trigger={['click']} className='flex items-center py-2 bg-[#1e1e1e] text-white' overlay={menu} placement="bottomRight">
...
export default ClientInfluencerProfileDetails;
