...
const ClientInfluencerInfluencerActivity = () => {
    return (
        <div>
                        ...
                        <div className='flex gap-3 border border-gray-600 rounded-lg p-2'>
                            ...
                            <div>
                                ...
                                <div className='mt-5'>
                                    ...
                                    <Link to={`/client/influencers/single-influencer-activity/${index}`} className='border block text-center border-gray-600 rounded-lg w-full py-2 px-5 mt-5'>View Post Analytics</Link>
                                </div>
                            </div>
                        </div>
                    ))
...
export default ClientInfluencerInfluencerActivity;
