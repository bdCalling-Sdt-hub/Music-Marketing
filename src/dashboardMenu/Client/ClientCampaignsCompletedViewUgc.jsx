...
const ClientCampaignsCompletedViewUgc = () => {
    return (
        <div>
                    ...
                    [...Array(8)].map((_, index) => (
                        <div className='flex gap-3 border border-gray-600 rounded-lg p-2'>
                            ...
                            <div>
                                ...
                                <div className='mt-5 '>
                                    <Link to={`/client/campaigns/completed/view-ugc/${index}`} className='border block text-center border-gray-600 rounded-lg w-full py-2 px-5 mt-5'>View Draft</Link>
...
export default ClientCampaignsCompletedViewUgc;
