...
const ClientCampaignsCompletedViewUgcViewDraftViewFeedback = () => {
    return (
        <div>
            <Link className='flex items-center gap-2 text-3xl font-semibold' to={`/client/campaigns/completed/view-ugc`}>
...
export default ClientCampaignsCompletedViewUgcViewDraftViewFeedback;
