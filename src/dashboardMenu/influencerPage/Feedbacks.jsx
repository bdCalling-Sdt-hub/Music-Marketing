        ...
        <div>
            ...
            <div className='mt-10 grid grid-cols-3 gap-5'>
                <div className='bg-primary rounded-lg p-5'>
                    ...
                    <button onClick={handleShowUploadField} className='bg-white py-3 px-10 rounded-lg font-semibold'>Upload New File</button>

                    {
                        showUploadField && (
                            <div>
                                <div className="w-full mt-5 border rounded-md border-white min-h-60 flex items-center justify-center flex-col">
                                ...
                                <button onClick={handleShowUploadField} className='bg-[#344331] mt-5 text-white w-full block text-center py-3 px-10 rounded-lg font-semibold'>Submit</button>
                            </div>
                        )
                    }
